    ...
    <section className="pt-3 pb-10">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm">
          ...
          nisi porro, cum veritatis ullam.
        </p>
      </div>
      {/* flex option */}
      ...
      {/* grid option */}
      <div className="sm:grid gap-5 grid-cols-4 grid-rows-2 sm:h-[400px] my-3">
        <TrendingCard
      ...
      <p className="text-sm">
        ...
        animi totam quos, inventore distinctio sequi quae, quibusdam nulla, odit
        dolorem minus sunt. Delectus, sunt eveniet?
      </p>
    </section>
  );
};
